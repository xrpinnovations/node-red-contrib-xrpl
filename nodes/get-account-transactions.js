/*
File:               get-account-transactions.js
...
module.exports = function(RED) {
    ...
    function GetAccountTransactions(n) {
        // Create a RED node
          ...
          if (server.isConnected()){
            try {
              if (XRPLib.isValidAddress(address)){
                XRPLib.getAccountTransactions(server, address).then((response) => {
    ...
    // Node functions.
    RED.nodes.registerType("get-account-transactions", GetAccountTransactions);
